...
const RegisterClient = dynamic(() => import('./RegisterClient'), {
  ssr: false,
  loading: () => (
    <div className="min-h-screen bg-[#F7F5F0] flex flex-col items-center justify-center space-y-4 font-sans" id="register-loading-screen">
