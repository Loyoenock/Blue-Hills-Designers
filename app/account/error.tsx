...
export default function Error({
  ...
  useEffect(() => {
    console.error('Account segment error:', error);
  }, [error]);

  return (
    <div className="min-h-[60vh] bg-[#F7F5F0] flex flex-col items-center justify-center p-6 text-center text-[#1D2B3F] font-sans">
      <h2 className="font-serif text-2xl font-bold mb-2">Executive Portal Error</h2>
      <p className="text-sm text-[#657892] max-w-md mb-6 font-light">
        We encountered a temporary issue while loading your account credentials.
      </p>
