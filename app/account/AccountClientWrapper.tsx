...
export default function AccountClientWrapper() {
  ...
  if (!mounted) {
    return (
      <div className="min-h-screen bg-[#F7F5F0] flex flex-col items-center justify-center space-y-4 font-sans" id="account-loading-screen">
